...
import { Loader2, Shield, Medal, Star, Gem, Crown, Zap, Gauge, Scale, AlertCircle, CreditCard, Target, DollarSign, ChevronRight, FileText, Tag, Clock, Wheat, Trophy, Award, Flame, Rocket, TrendingUp, Dog, Swords, Coins, Wallet, PiggyBank, Landmark, Mountain } from "lucide-react";
import {
  XAxis,
  YAxis,
  CartesianGrid,
