        ...
        <div className="flex items-end -space-x-4 sm:-space-x-6 min-w-0">
          ...
          <div className="min-w-0 pb-1">
            <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
              <h1 className="font-black italic text-2xl sm:text-4xl lg:text-5xl text-foreground tracking-tight uppercase leading-none truncate ml-[5px] mr-[5px]" style={{ fontFamily: "'Barlow Condensed', sans-serif" }} data-testid="text-dashboard-title">
