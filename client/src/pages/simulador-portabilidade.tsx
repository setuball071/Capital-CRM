...
export default function SimuladorPortabilidadePage() {
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .consultor-side{display:flex;align-items:flex-end;padding:18px 32px 0 32px;background:linear-gradient(135deg,#6C2BD9 0%,#1E88E5 100%);flex:0 0 auto;min-width:260px;-webkit-print-color-adjust:exact;print-color-adjust:exact}
    .consultor-foto{height:110px;width:auto;max-width:100px;object-fit:contain;object-position:bottom;margin-right:14px;flex-shrink:0;-webkit-print-color-adjust:exact;print-color-adjust:exact}
    ...
    .consultor-info{padding-bottom:16px;}
