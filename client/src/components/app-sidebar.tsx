...
export function AppSidebar() {
  ...
  const menuSections: MenuSection[] = [
    ...
    },
    {
      ...
      icon: TrendingUp,
      items: [
        { title: "Caixa", url: "/financeiro/caixa", icon: Wallet, rolesAllowed: ["master", "coordenacao"] },
        { title: "Contas a Pagar", url: "/financeiro/contas-pagar", icon: CalendarClock, rolesAllowed: ["master", "coordenacao"] },
        { title: "Planejamento", url: "/financeiro/planejamento", icon: Target, rolesAllowed: ["master", "coordenacao"] },
        { title: "Revisão de Custos", url: "/financeiro/revisao", icon: SearchCheck, rolesAllowed: ["master", "coordenacao"] },
