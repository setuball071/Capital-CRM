  ...
  const menuSections: MenuSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Editor PDF", url: "/operacional/editor-pdf", icon: FileEdit },
      ],
    },
    {
      title: "Referências",
