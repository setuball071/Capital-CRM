...
${JSON.stringify(roteirosParaIA, null, 2)}`
  ...
  app.get("/api/clientes/filtros", requireAuth, requireModuleAccess("modulo_base_clientes"), async (req, res) => {
    try {
      ...
      return res.json({ convenios, orgaos, orgaosComCodigo, ufs, bancos, tiposContrato });
    } catch (error) {
      ...
      return res.json({
        ...
        folha: {
          atual: folhaAtual ? {
            ...
            margem_saldo_5: folhaAtual.margemSaldo5 != null ? parseFloat(folhaAtual.margemSaldo5) : null,
            // Margem Benefício 5% (cartão benefício)
            margem_beneficio_bruta_5: folhaAtual.margemBeneficioBruta5 != null ? parseFloat(folhaAtual.margemBeneficioBruta5) : null,
            margem_beneficio_utilizada_5: folhaAtual.margemBeneficioUtilizada5 != null ? parseFloat(folhaAtual.margemBeneficioUtilizada5) : null,
            margem_beneficio_saldo_5: folhaAtual.margemBeneficioSaldo5 != null ? parseFloat(folhaAtual.margemBeneficioSaldo5) : null,
            // Margem 35%
            margem_bruta_35: folhaAtual.margemBruta35 != null ? parseFloat(folhaAtual.margemBruta35) : null,
            margem_utilizada_35: folhaAtual.margemUtilizada35 != null ? parseFloat(folhaAtual.margemUtilizada35) : null,
            margem_saldo_35: folhaAtual.margemSaldo35 != null ? parseFloat(folhaAtual.margemSaldo35) : null,
            // Margem 70%
            margem_bruta_70: folhaAtual.margemBruta70 != null ? parseFloat(folhaAtual.margemBruta70) : null,
            margem_utilizada_70: folhaAtual.margemUtilizada70 != null ? parseFloat(folhaAtual.margemUtilizada70) : null,
            margem_saldo_70: folhaAtual.margemSaldo70 != null ? parseFloat(folhaAtual.margemSaldo70) : null,
            // Campos legados (mantidos para compatibilidade)
            margem_cartao_credito_saldo: folhaAtual.margemCartaoCreditoSaldo != null ? parseFloat(folhaAtual.margemCartaoCreditoSaldo) : null,
            margem_cartao_beneficio_saldo: folhaAtual.margemCartaoBeneficioSaldo != null ? parseFloat(folhaAtual.margemCartaoBeneficioSaldo) : null,
            salario_bruto: folhaAtual.salarioBruto != null ? parseFloat(folhaAtual.salarioBruto) : null,
            descontos_brutos: folhaAtual.descontosBrutos != null ? parseFloat(folhaAtual.descontosBrutos) : null,
  ...
  app.post("/api/employees/import-json", requireAuth, requireModuleAccess("modulo_config_usuarios", "edit"), async (req, res) => {
    try {
      ...
      const mappedData = {
        ...
        valeTransporte: data.valeTransporte === true || data.valeTransporte === "true",
        valeRefeicao: data.valeRefeicao === true || data.valeRefeicao === "true",
        descansoSabado: data.descansoSabado === true || data.descansoSabado === "true",
        descansoDomingo: data.descansoDomingo === true || data.descansoDomingo === "true" || data.descansoDomingo === null,
