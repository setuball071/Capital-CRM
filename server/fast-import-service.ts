  ...
  private async mergeFolha(
    ...
    const folhaResult = await db.execute(sql`
      ...
      SELECT DISTINCT ON (v.id, ${competencia}::timestamp)
        ...
        CASE WHEN s.margem_70_saldo::numeric >= 0 THEN LEAST(s.margem_5_saldo::numeric, s.margem_70_saldo::numeric) ELSE s.margem_5_saldo::numeric END,
        s.margem_beneficio_5_bruta::numeric,
        s.margem_beneficio_5_utilizada::numeric,
        CASE WHEN s.margem_70_saldo::numeric >= 0 THEN LEAST(s.margem_beneficio_5_saldo::numeric, s.margem_70_saldo::numeric) ELSE s.margem_beneficio_5_saldo::numeric END,
        s.margem_35_bruta::numeric,
        s.margem_35_utilizada::numeric,
        CASE WHEN s.margem_70_saldo::numeric >= 0 THEN LEAST(s.margem_35_saldo::numeric, s.margem_70_saldo::numeric) ELSE s.margem_35_saldo::numeric END,
      ...
      ON CONFLICT (vinculo_id, competencia) DO UPDATE SET
        ...
        margem_saldo_5 = CASE WHEN EXCLUDED.margem_saldo_70 >= 0 THEN LEAST(COALESCE(EXCLUDED.margem_saldo_5, clientes_folha_mes.margem_saldo_5), EXCLUDED.margem_saldo_70) ELSE COALESCE(EXCLUDED.margem_saldo_5, clientes_folha_mes.margem_saldo_5) END,
        ...
        margem_beneficio_saldo_5 = CASE WHEN EXCLUDED.margem_saldo_70 >= 0 THEN LEAST(COALESCE(EXCLUDED.margem_beneficio_saldo_5, clientes_folha_mes.margem_beneficio_saldo_5), EXCLUDED.margem_saldo_70) ELSE COALESCE(EXCLUDED.margem_beneficio_saldo_5, clientes_folha_mes.margem_beneficio_saldo_5) END,
        ...
        margem_saldo_35 = CASE WHEN EXCLUDED.margem_saldo_70 >= 0 THEN LEAST(COALESCE(EXCLUDED.margem_saldo_35, clientes_folha_mes.margem_saldo_35), EXCLUDED.margem_saldo_70) ELSE COALESCE(EXCLUDED.margem_saldo_35, clientes_folha_mes.margem_saldo_35) END,
