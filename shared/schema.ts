...
export const tenantThemeSchema = z.object({
  ...
  moduloPerformanceEnabled: z.boolean().optional(), // Habilitar módulo de metas/performance para vendedores
  // Metadados de edição
...
export const filtrosPedidoListaSchema = z.object({
  ...
  sit_func: z.union([z.string(), z.array(z.string())]).optional(),
  ...
  bancos_excluir: z.array(z.string()).optional(),
