...
export const stagingFolha = pgTable("staging_folha", {
  ...
  salarioBruto: decimal("salario_bruto", { precision: 15, scale: 2 }),
  descontosBrutos: decimal("descontos_brutos", { precision: 15, scale: 2 }),
  salarioLiquido: decimal("salario_liquido", { precision: 15, scale: 2 }),
